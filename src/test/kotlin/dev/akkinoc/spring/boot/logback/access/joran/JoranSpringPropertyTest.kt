...
/**
 * Tests the [JoranSpringPropertyTest] using the Undertow servlet web server.
 */
@UndertowServletWebTest
class UndertowServletWebJoranSpringPropertyTest : JoranSpringPropertyTest()

/**
 * Tests the [JoranSpringPropertyTest] using the Undertow reactive web server.
 */
@UndertowReactiveWebTest
class UndertowReactiveWebJoranSpringPropertyTest : JoranSpringPropertyTest()
