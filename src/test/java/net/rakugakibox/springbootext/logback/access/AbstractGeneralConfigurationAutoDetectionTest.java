...
/**
 * The base class to test that auto-detect general configuration file.
 */
@RunWith(SpringJUnit4ClassRunner.class)
@SpringApplicationConfiguration
@WebIntegrationTest(randomPort = true)
public abstract class AbstractGeneralConfigurationAutoDetectionTest {
    ...
    public static TestRule classRule() {
        return new ClassPathRule(AbstractGeneralConfigurationAutoDetectionTest.class);
    }
    ...
    public void testAutoDetected() {
        ...
        IAccessEvent event = NamedEventQueues.pop("logback-access.xml");
