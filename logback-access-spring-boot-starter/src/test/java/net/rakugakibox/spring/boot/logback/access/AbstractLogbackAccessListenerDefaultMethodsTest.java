...
/**
 * The base class for testing the {@link LogbackAccessListener}'s default methods.
 */
...
public abstract class AbstractLogbackAccessListenerDefaultMethodsTest {
    ...
    public static abstract class AbstractContextConfiguration {
        ...
        /**
         * Creates a listener for Logback-access using the default methods.
         *
         * @return a listener for Logback-access using the default methods.
         */
        @Bean
        @Order(Ordered.HIGHEST_PRECEDENCE)
        public LogbackAccessDefaultListener logbackAccessDefaultListener() {
            return new LogbackAccessDefaultListener();
        }

    }

    /**
     * The listener for Logback-access using the default methods.
     */
    public static class LogbackAccessDefaultListener implements LogbackAccessListener {
    }
