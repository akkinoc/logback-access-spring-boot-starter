...
/**
 * Class for testing to auto detect test spring configuration file.
 */
@RunWith(Parameterized.class)
@EnableAutoConfiguration(exclude = SecurityAutoConfiguration.class)
@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.RANDOM_PORT)
public class SpringConfigurationFileAutoDetectingTest extends AbstractWebContainerTest {
    ...
    public static TestRule classRule() {
        return new ClassPathRule(SpringConfigurationFileAutoDetectingTest.class);
    }
