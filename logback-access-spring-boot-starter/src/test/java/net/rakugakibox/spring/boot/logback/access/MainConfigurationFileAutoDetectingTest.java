...
public abstract class MainConfigurationFileAutoDetectingTest extends AbstractWebContainerTest {
    ...
    public static TestRule classRule() {
        return new ClassPathRule(MainConfigurationFileAutoDetectingTest.class);
    }
